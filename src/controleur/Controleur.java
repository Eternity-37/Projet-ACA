...
public class Controleur {
    ...
    private final Joueurs ordinateur;
    /**
    ...
    public void jouer() {
        ...
        boolean estuneIA = ihm.estIA();
        if (estuneIA) {
            ordinateur.setjoueur("IA");
            ...
            while (etatjeu) {
                ...
                while (!Jeux.partieFinie(plateau)) {  // Tant que la partie n'est pas terminée
                    ...
                    if (joueurcourant == 1) {
                        ...
                        AbstractMap.SimpleEntry<Integer,Integer> coups = IARandom.coupIA(Jeux.coupPossibleJoueurs(2,plateau));
                        int x = coups.getKey();
                        int y = coups.getValue();
